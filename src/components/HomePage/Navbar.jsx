  ...
  return (
    <div>
      <Modal
        ...
        aria-describedby="modal-modal-description"
      >
        <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-96 h-[550px] bg-white shadow-lg p-4 rounded-xl">
          <div className="flex flex-col justify-center items-center gap-5 my-2">
            <img src={GOOGLE_LOGO} alt="" className="w-[100px]" />
            <div className="text-center">
              <p className="text-xl font-semibold">Sign in</p>
            ...
            <div className="flex flex-col gap-2">
              <div>
                ...
                <input
                  ...
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  className="border-2 p-2 w-full my-2 focus:outline-none focus:ring-0"
                  placeholder="johndoe@gmail.com"
                />
              </div>
              ...
              <div className="m-auto">
                <button
                  className="bg-[#1B73E9] p-2 text-[#fff] rounded-lg w-full"
                  onClick={sigupWIthEmailAndPass}
                >
                  Sign Up
                </button>
      ...
      <div className="flex justify-between p-2 items-center shadow-md">
        ...
        <div className="flex gap-5 mr-2 sm:mr-10">
          <button
            className="p-2 text-[#1A73E8] font-semibold text-[18px] hover:bg-[#F5f5f5] rounded-md"
            onClick={openModal}
          >
            Sign in
          </button>
